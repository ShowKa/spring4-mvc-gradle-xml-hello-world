...
/**
 * MKokyakuTantoBushoId generated by hbm2java
 */
@Embeddable
public class MKokyakuTantoBushoId implements java.io.Serializable {

	private String kokyakuCode;
	private String bushoCode;

	public MKokyakuTantoBushoId() {
	}

	public MKokyakuTantoBushoId(String kokyakuCode, String bushoCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MKokyakuTantoBushoId))
			return false;
		MKokyakuTantoBushoId castOther = (MKokyakuTantoBushoId) other;
