...
/**
 * The primary key class for the m_kokyaku_tanto_busho database table.
 * 
 */
@Embeddable
public class MKokyakuTantoBushoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof MKokyakuTantoBushoPK)) {
			return false;
		}
		MKokyakuTantoBushoPK castOther = (MKokyakuTantoBushoPK)other;
		return 
