...
/**
 * MKokyakuTantoBushoHanbaiId generated by hbm2java
 */
@Embeddable
public class MKokyakuTantoBushoHanbaiId implements java.io.Serializable {

	private String kokyakuCode;
	private String bushoCode;

	public MKokyakuTantoBushoHanbaiId() {
	}

	public MKokyakuTantoBushoHanbaiId(String kokyakuCode, String bushoCode) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MKokyakuTantoBushoHanbaiId))
			return false;
		MKokyakuTantoBushoHanbaiId castOther = (MKokyakuTantoBushoHanbaiId) other;
